                        ...
                        <div class="row">
                          <div class="col-lg-4 mb-5 mb-lg-0">
                            <div class="card">
                              <div>
                                <img src="assets/img/content/img_01.jpg" alt="News">
                                <div class="badges badges-left badges-top pl-2 pt-1 text-white">
                                  <a class="badge badge-warning text-secondary fw-600" href="#">Daily Deal</a>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-8">
                            <div class="text-gray">
                              <h5 class="text-uppercase fw-600"><a href="news-article.html">Mauris ornare</a></h5>
                              <div class="small-3 mb-2">
                                <span class="mr-2"><i class="fas fa-calendar-alt mr-1"></i> 9:00pm</span>
                                <a href="news-article.html" class="comments"><i class="fas fa-comment-alt mr-1"></i> <span>0</span> comments</a>
                              </div>
                              <p>Aliquam ipsum elit, lobortis et elit ultrices, suscipit hendrerit ligula. Morbi vulputate, urna in tincidunt lacinia, orci lectus convallis lectus, vel dictum felis urna eget nisi. Proin ac bibendum diam.</p>
                            </div>
                          </div>
