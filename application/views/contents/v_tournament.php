...
<main class="main-content">
  ...
  <section class="content-section owl-carousel-spotlight carousel-spotlight ig-carousel text-light pt-7" style="background-image: url(assets/img/bg/bg_shape.png);">
    <header class="header text-center ">
      <h2><a href="#" onclick="alert('Coming Soon')" class="btn btn-xl btn-warning text-secondary mr-2">Create Own Tournament</a></h2>
    </header>
    <div class="container">
          ...
          <div class="tab-pane fade show active" id="mp-01-c" role="tabpanel" aria-labelledby="mp-01-tab">
            <div class="row">
              <?php foreach ($turgg as $key2) { ?>
                <!-- item -->
                <div class="item m-4" style="width: 30%">
                  <div class="item-cont">
                        ...
                        <div class="position-relative overflow-hidden">
                          ...
                          <div class="review_h text-light">
                            <a href="#">
                              ...
                              <span class="item_atc_text"><a href="<?= base_url(); ?>daftar_tournament?ID_TOURNAMENT=<?= $key2["ID_TOURNAMENT"]?>">Daftarkan</a></span>
                            </a>
                          </div>
                        </div>
                        <div>
                          <p style="font-size: 12px;" class="owl_item_title text-lt"><b><?php echo $key2["NAMA_TOURNAMENT"]; ?></b></p>
                          <h7 class="owl_item_title text-lt">Max Peserta / Tim : <?php echo $key2["MAX_PESERTA"]; ?></h7>
                          <br>
                          <h7 class="owl_item_title text-lt">Biaya Pendaftaran : Rp <?php echo number_format($key2["BIAYA_PENDAFTARAN"], 0, ',', '.'); ?></h7>
                          <br>
                          <h7 class="owl_item_title text-lt">Prize Pool (Max) : Rp <?php echo number_format($key2["BIAYA_PENDAFTARAN"] * $key2["MAX_PESERTA"], 0, ',', '.'); ?></h7>
                          <br>
                          <h7 class="owl_item_title text-lt">Tanggal Turnamen : <?php echo date("d - F - Y", strtotime($key2["TANGGAL_TOURNAMENT"])); ?></h7>
                        </div>
                    </figure>
                  </div>
                </div>
              ...
              <div class="row">
                <?php foreach ($turgg as $key2) { ?>
                  <?php if ($key["ID_GAME"] == $key2["ID_GAME"]) { ?>
                    ...
                    <!-- item -->
                    <div class="item m-3" style="width: 30%">
                      <div class="item-cont">
                        <figure class="owl_item_review">
                          <div>
                            <div class="position-relative overflow-hidden">
                            ...
                            <div>
                              <p style="font-size: 12px;" class="owl_item_title text-lt"><b><?php echo $key2["NAMA_TOURNAMENT"]; ?></b></p>
                              <h7 class="owl_item_title text-lt">Max Peserta : <?php echo $key2["MAX_PESERTA"]; ?></h7>
                              <br>
                              <h7 class="owl_item_title text-lt">Biaya Pendaftaran : Rp <?php echo number_format($key2["BIAYA_PENDAFTARAN"], 0, ',', '.'); ?></h7>
                              <br>
                              <h7 class="owl_item_title text-lt">Prize Pool (Max) : Rp <?php echo number_format($key2["BIAYA_PENDAFTARAN"] * $key2["MAX_PESERTA"], 0, ',', '.'); ?></h7>
