          ...
          <div class="row gutters-y">
              <div class="col-6 col-lg-2">
                ...
                <div class="social-buttons">
                  <a class="social-youtube" href="#"><i class="fab fa-youtube fa-2x">Youtube</i></a>
                </div>
              </div>

              <div class="col-6 col-lg-2">
                <h6 class="text-uppercase fw-600 mb-4">Games Forum</h6>
                <div class="nav flex-column">
                  <a class="nav-link" href="news.html">Mobile Legends</a>
                  <a class="nav-link" href="news.html">PUBG</a>
                  <a class="nav-link" href="news.html">AOV</a>
                  <a class="nav-link" href="news.html">DOTA 2</a>
                </div>
              </div>

              <div class="col-6 col-lg-2">
                <h6 class="text-uppercase fw-600 mb-4">Contact Us</h6>
                <div class="nav flex-column social-buttons ">
                  <a class="social-twitter" href="#"><i class="fab fa-twitter">Twitter </i> </a>
                  <a class="social-instagram" href="#"><i class="fab fa-instagram">Instagram </i> </a>
                  <a class="social-facebook" href="#"><i class="fab fa-facebook">Facebook </i> </a>
                </div>
              </div>
              ...
              <div class="col col-lg-3 order-lg-last">
                <div class="mb-6">
                  ...
                  <div class="text-light lead-5 lh-1">
                    <a href="#" class="social-twitter"><i class="fab fa-google-play"></i></a>
                    <a href="#" class="social-instagram"><i class="fab fa-app-store"></i></a>
                  </div>
                </div>
          </div>
      </div>
