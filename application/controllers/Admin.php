...
class Admin extends CI_Controller
{
    ...
    public function indexTournamentUser()
    {
?> <script>
            alert('Coming Soon')
        </script> <?php
                    // redirect('games_admin_tournament');
                }
                ...
                public function daftarPeserta()
                {
                    ...
                    $data['daftarPeserta'] = $this->Tournament_model->getAllPesertaTournament($ID_TOURNAMENT);
                ...
                public function ubahStatus()
                {
                    $id = $this->input->post('id');
                    $ID_TOURNAMENT = $this->input->get('ID_TOURNAMENT');
                    $data['status'] = json_encode($this->Tournament_model->ubahStatus($id));
                    // $back = base_url().'daftar_peserta?ID_TOURNAMENT='.$ID_TOURNAMENT;
                ...
                public function getPesertaId()
                {
                    $id = $this->input->post('id');
                    echo json_encode($this->Tournament_model->getPesertaById($id));
                }
